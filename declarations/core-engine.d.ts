            ...
            export module api {
                export module container {
                    ...
                    export class ItemContainer extends java.lang.Object implements innercore.api.mod.recipes.workbench.WorkbenchField {
                        ...
                        /**
                         * Собирает новый [[ItemContainer]] объект
                         */
                        constructor();
                        /**
                         * Собирает новый [[ItemContainer]] объект и даёт устаревший [[innercore.api.mod.ui.container.Container]] объект
                         */
                        ...
                        /**
                         * Проверяет и очищает все пустые слоты в контейнере
                         */
                        validateAll(): void;
                        /**
                         * Проверяет содержимое слота. Если значение данных меньше 0, 
                         * оно становится 0, если id равен 0 или 
                         * count меньше или равен нулю, слот сбрасываетсяна пустой
                         * @param name slot name
                         */
                        validateSlot(name: string): void;
                        /**
                         * Очищает содержимое слотов
                         * @param название слота
                         */
            ...
            export module api {
                export module container {
                    export class ItemContainerSlot extends java.lang.Object implements innercore.api.mod.ui.container.AbstractSlot {
                        ...
                        /**
                         * @возвращает числовые айди предметов в слоте.
                         */
                        getId(): number;
                        /**
                         * @возвращает количество предметов в слоте
                         */
                        getCount(): number;
                        /**
                         * @возвращает дату предмета в слоте
                         */
                        getData(): number;
                        /**
...
declare namespace Block {
	...
	interface SpecialType {
		/**
		 * Уникальный строковой идентификатор для специального типа
		 */
		name?: string,
		...
		/**
		 * Константы материалов блоков. Изначальное количество: 3
		 */
		material?: number,
...
declare namespace Dimensions {
    ...
    interface NoiseLayerParams {
        octaves: NoiseOctaveParams[] | {
            ...
            scale_factor?: number,
            scale?: [first:number,second:number,third:number] | number
        },
        conversion?: NoiseConversionParams
    }
...
declare namespace Entity {
    ...
    /**
     * @возвращает истину,если игрок крадётся.Иначе возвращает ложное булевое значение.
     */
...
declare namespace Player {
    ...
    function get(): number;
 /**
     * @Возвращает идентификатор локального игрока используемый в модуле [[Entity]] 
     * 
     */
